...
public class LeaderboardForm extends javax.swing.JFrame {
    ...
    public void initTableData() {
        table = (DefaultTableModel)leaderboard.getModel();
        
        Vector col_iden = new Vector();
        col_iden.add("Player");
        col_iden.add("Score");
        
        try {
            FileInputStream file_stream = new FileInputStream(leaderboardFile);
            ObjectInputStream object_stream = new ObjectInputStream(file_stream);

            table.setDataVector((Vector) object_stream.readObject(), col_iden);
    ...
    private void saveLeaderboard() {
        try {
            FileOutputStream file_stream = new FileOutputStream(leaderboardFile);
            ObjectOutputStream object_stream = new ObjectOutputStream(file_stream);

            object_stream.writeObject(table.getDataVector());
    ...
    public void addPlayerName(String playerName, int score) {
        table.addRow(new Object[] {playerName, score});
        sorter.sort();
        saveLeaderboard();
